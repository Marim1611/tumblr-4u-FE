...
export const store = new Vuex.Store({
  ...
  state: {
    ...
    homeTheme: [
      ...
      {
        backgroundColor:
          "linear-gradient(to top right, #ffff99 0%, #ffcc99 100%)",
        fontColor: "#840000",
        cardColor: "linear-gradient(to top right, #ffff99 0%, #cc3300 100%)",
        fontColor2: "white",
        fontStyle: "Helvetica",
        focused: "#840000",
        shadow: "rgb(163, 162, 162)",
      ...
      },
      {
        ...
        fontColor: "white",
        cardColor: "linear-gradient(to bottom, #3399ff 0%, #ff99cc 100%)",
        fontColor2: "#1A314D",
        fontStyle: "Helvetica",
        focused: "pink",
        shadow: "rgb(163, 162, 162)",
    ...
    exploreCards: [
      {
        ...
        color: "salmon",
        imgs: [
          "https://64.media.tumblr.com/24df9cff9e69d1d44fa04a3ddc3d9cd6/71b567e6ee69be1a-3e/s400x600/ac34cf5e3182ce4026554369a0b232fd999e4b2e.jpg",
          "https://64.media.tumblr.com/72424fd76f4e4d8a560d7b441a1cd4a2/00aac923bd3df1f9-74/s400x600/c3fb7836bae4669cb89775078f05763b7cbe1d06.jpg",
          "https://64.media.tumblr.com/43e40c52989b17d40c35fa6670ea0003/00aac923bd3df1f9-6d/s400x600/b86103a8e75504ac924a4ae5c2a80ae27bcb918e.jpg",
          "https://64.media.tumblr.com/7ed22734280b98b5f077f207c74f007a/00aac923bd3df1f9-2c/s400x600/e4691d822958bf32606fcee164b532d76a87686c.jpg",
        ],
      },
      {
        tag: "cat",
        color: "peru",
        imgs: [
          "https://64.media.tumblr.com/fac5c6a2db42277881f503777f2c197e/37d6b92c3301c2d7-37/s250x250_c1/410a950704b97536e6433c8e919ae7c03b6d6211.jpg",
          "https://64.media.tumblr.com/484b480818fa3bc687410bef3efa5316/ffbfeafe5f8cb1cb-06/s250x250_c1/b2e967b99097633e591b9c866b46c1a184c102ea.jpg",
        ],
      },
      {
        tag: "trees",
        color: "teal",
        imgs: [
          "https://64.media.tumblr.com/b5358fc009466df1bacb981196f3a07b/cd8594cf82ba4ed7-a8/s250x250_c1/29ed4459137544a163e725a95c5ae2f405be251d.jpg",
          "https://64.media.tumblr.com/54bd1594edf5f304e0ece685a5ad35d8/00aac923bd3df1f9-32/s400x600/b4b682389068c5c9bacc260991af17d2692e8299.jpg",
          "https://64.media.tumblr.com/d6a8e57141a539d2a56412ff65045fdb/00aac923bd3df1f9-a5/s400x600/4ce247d9edb1a38e18428218ae20a5ee7de32c0a.jpg",
        ],
      },
      {
        tag: "photography",
    ...
    blogs: [
      {
        ...
        comments: [
          ...
          },
          {
            ...
            name: "bees-in-the-machine",
            content:
              "I can’t believe there are people on earth who can draw like this",
          },
          {
            avatar:
              "https://assets.tumblr.com/images/default_avatar/cone_open_64.png",
      ...
      },
      {
        blogId: "university",
        postHtml:
          '<img width="100%" src="https://64.media.tumblr.com/94d47f2a348e420a4027a727446200c7/e2ff9c994d64544a-9b/s400x600/9a49e3d57d5745cebac87493880ae1fa232548a8.jpg" alt="">',
        tags: [],
        notes_cnt: 18910,
        likes_cnt: 18000,
        reblogs_cnt: 900,
      ...
      },
      {
        blogId: "university",
        postHtml:
          '<img width="100%" src="https://64.media.tumblr.com/56bf68dab228b3f39dcd6bcdef4bbc83/b3b2c4400e57caa1-17/s400x600/b724f4a30108da4cca303eec1d130a8874212bb8.png" alt="">',
      ...
      },
      {
        blogId: "university",
        postHtml:
          '<img width="100%" src="https://64.media.tumblr.com/45dde30f17353eb13ca1be55063e3484/1ef148912162fc2f-7e/s400x600/739708b94fe41c6b50eee06fd95d8d08eeaa0cb4.jpg" alt="">',
        tags: ["wholesome"],
        notes_cnt: 18910,
        likes_cnt: 18000,
        reblogs_cnt: 900,
      ...
      },
      {
        blogId: "onlypositive",
        postHtml:
          '<img width="100%" src="https://64.media.tumblr.com/59c510e0df411afe28a473cea2d4688d/0dc62628d204ab8c-83/s400x600/bf01b9297a94090eb252d52b0856da3c8af799ab.jpg" alt=""><p>Make sure to rest and drink enough water ♥ </p>',
      ...
      },
      {
        blogId: "sillydegu",
        postHtml:
          '<img width="100%" src="https://www.theme-junkie.com/wp-content/uploads/Old-Black-and-White-Backgrounds-1.jpg" alt=""><strong>Every morning, we get a chance to be different.</strong> A chance to change. A chance to be better. Your past is your past. Leave it there. Get on with the future part. Nicole Williams',
        tags: [
          "Nicole Williams",
          "relationship",
          "love",
  ...
  mutations: {
    ...
    blog_init(state,blog) {
      ...
      state.blog.isBlocked=blog.isBlocked;
    },
    auth_error(state) {
      state.status = "error";
    },
...
actions: {
  async login({ commit }, user) {
   ...
   return new Promise((resolve, reject) => {
     ...
     if (Browser().baseURL == "http://tumblr4u.eastus.cloudapp.azure.com:5000")
     {
  ...
  //  localStorage.setItem("colorBody", res.data.res.data.user);
     ...
     /// Mock 
      ...
      axios.get( Browser().baseURL+'/login')
      .then((res) => {
        const token = res.data.res.data.token;
        const user = res.data.res.data.user;
        const blog = res.data.res.data.blog;
